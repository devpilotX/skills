...
Someone whose invoice doubled types "why did my bill go up" or "I think I got overcharged", not "unexpected spend variance". Someone whose skill scores nine types "my skill wont pass" or "stuck at nine", not "criterion coverage gap". Collect the phrases by imagining the person with the problem at the moment they reach for help, before they know the cause. That moment is when the skill has to fire.
